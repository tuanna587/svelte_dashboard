...
<nav class="absolute top-0 left-0 w-full z-10 bg-transparent dark:bg-slate-900 md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
  <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-5 px-3">
    ...
    <div class="md:flex hidden flex-row flex-wrap items-center lg:ml-auto mr-3">
      <!-- Search -->
      <button class="p-2 bg-gray-700 bg-opacity-50 focus:bg-slate-500 focus:bg-opacity-50 rounded-full text-sky-400 shadow-lg font-normal h-10 w-10 flex items-center justify-center align-center outline-none focus:outline-none mr-2" type="button" on:click={toggleSearch}>
