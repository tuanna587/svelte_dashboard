<script>
  ...
  >
    ...
    >
      <!-- Toggler -->
      <button
        class="cursor-pointer text-black dark:text-red-600 opacity-50 dark:opacity-80 md:hidden px-3 py-1 text-xl leading-none bg-transparent rounded border border-solid border-transparent"
        type="button"
      ...
      >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
          <li class="items-center">
            <a
              ...
              class="text-xs uppercase py-3 font-bold block {$location.indexOf('/admin/dashboard') !== -1 ? 'text-red-500 hover:text-red-600':'text-slate-700 hover:text-slate-500'}"
            >
              <i
                class="fas fa-tv mr-2 text-sm {$location.indexOf('/admin/dashboard') !== -1 ? 'opacity-75' : 'text-slate-300'}"
              ></i>
              Dashboard
            </a>
          </li>
          ...
          <li class="items-center">
            <a
              use:link
              href="/admin/settings"
              class="text-xs uppercase py-3 font-bold block {$location.indexOf('/admin/settings') !== -1 ? 'text-red-500 hover:text-red-600':'text-slate-700 hover:text-slate-500'}"
            >
              <i
                class="fas fa-tools mr-2 text-sm {$location.indexOf('/admin/settings') !== -1 ? 'opacity-75' : 'text-slate-300'}"
              ></i>
              Settings
            </a>
          </li>
          ...
          <li class="items-center">
            <a
              use:link
              href="/admin/tables"
              class="text-xs uppercase py-3 font-bold block {$location.indexOf('/admin/tables') !== -1 ? 'text-red-500 hover:text-red-600':'text-slate-700 hover:text-slate-500'}"
            >
              <i
                class="fas fa-table mr-2 text-sm {$location.indexOf('/admin/tables') !== -1 ? 'opacity-75' : 'text-slate-300'}"
              ></i>
              Tables
            </a>
          </li>
          ...
          <li class="items-center">
            <a
              use:link
              href="/admin/maps"
              class="text-xs uppercase py-3 font-bold block {$location.indexOf('/admin/maps') !== -1 ? 'text-red-500 hover:text-red-600':'text-slate-700 hover:text-slate-500'}"
            >
              <i
                class="fas fa-map-marked mr-2 text-sm {$location.indexOf('/admin/maps') !== -1 ? 'opacity-75' : 'text-slate-300'}"
              ></i>
              Maps
            </a>
          </li>
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
          <li class="inline-flex">
            <a
              href="http://svelte01.IntLighttech.com/docs/colors"
              target="_blank"
              class="text-slate-700 hover:text-slate-500 text-sm block mb-4 no-underline font-semibold"
            >
              <i class="fas fa-paint-brush mr-2 text-slate-300 text-base"></i>
              Styles
            </a>
          </li>
          ...
          <li class="inline-flex">
            <a
              href="http://svelte01.IntLighttech.com/docs/components"
              target="_blank"
              class="text-slate-700 hover:text-slate-500 text-sm block mb-4 no-underline font-semibold"
            >
              <i class="fab fa-css3-alt mr-2 text-slate-300 text-base"></i>
              CSS Components
            </a>
          </li>
