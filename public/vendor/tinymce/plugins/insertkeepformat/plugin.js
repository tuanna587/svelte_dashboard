(function () {
      ...
      var dataApi = editor.windowManager.open({
        ...
        body: {
          ...
          items: [
            {
              type: 'htmlpanel',
              html: '<div class="mce-insertkeepformat" id="mce-insertkeepformat-'+editor.id+'" contenteditable="true" style="width:100%;height:450px; overflow-y:auto; border:1px solid #ddd; padding: 15px;"></div>'
            }
          ]
        },
        buttons: [
        ...
        onSubmit: function(api){
          ...
          var content = $('#mce-insertkeepformat-'+tinymce.activeEditor.id).html();
    ...
    var register$1 = function (editor) {
      editor.ui.registry.addButton('insertkeepformat', {
        icon: 'insertkeepformat',
        tooltip: 'Insert Keep Format',
        onAction: function () {
          return editor.execCommand('insertRawHtml');
        },
      });
      editor.ui.registry.addMenuItem('insertkeepformat', {
        icon: 'insertkeepformat',
        text: 'Insert Keep Format',
        onAction: function () {
          return editor.execCommand('insertRawHtml');
        }
      });
    ...
    function Plugin () {
      global.add('insertkeepformat', function (editor) {
        register(editor);
        register$1(editor);
      });
    }
