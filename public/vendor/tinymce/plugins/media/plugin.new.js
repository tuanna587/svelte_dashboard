...
(function() {
    ...
    var hasResponsive = function(editor) {
        return editor.getParam('media_responsive', true);
    };
    ...
    var htmlToData = function(prefixes, html) {
            ...
            start: function(name, attrs) {
                if (isEphoxEmbed.get());
                    ...
                    if (name === 'img' && !data.poster) {
                        ...
                        // data.responsive = attrs.map.responsive;
                    }
        ...
        data.responsive = data.responsive || false;
        console.log('2',data);
        return data;
    };
    ...
    var dataToHtml = function(editor, dataIn) {
        ...
        data.responsive = JSON.parse(data.responsive);
    ...
    var defaultPromise = function(data, dataToHtml) {
        // return console.log(data, dataToHtml);
    ...
    var unwrap = function(data, sourceInput) {
        ...
        return __assign(__assign(__assign(__assign(__assign({}, get('source')), get('altsource')), get('poster')), get('embed'), get('responsive')), getDimensions(data, metaData));
    };
    ...
    var getEditorData = function(editor) {
        ...
        // console.log(element, snippet, getScripts(editor));
        return __assign({
            embed: snippet
    ...
    var submitForm = function(prevData, newData, editor) {
        // return console.log(newData.embed, newData);
        newData.embed = updateHtml(newData.embed, newData);
        if (newData.embed && (prevData.source === newData.source || isCached(newData.source))) {
            console.log('1', newData.embed, newData);

            handleInsert(editor, newData.embed);
        } else {
            getEmbedHtml(editor, newData).then(function(response) {
                console.log(newData.embed, newData, response);
    ...
    var showDialog = function(editor) {
        ...
        var handleUpdate = function(api, sourceInput) {
            // console.trace();
            // return console.log('handleUpdate',api.getData(), sourceInput);
            var data = unwrap(api.getData(), sourceInput);
            var embed = dataToHtml(editor, data);
            // return console.log('handleUpdate',embed, data);
        ...
        var win = editor.windowManager.open({
            ...
            onSubmit: function(api) {
                ...
                console.log('onSubmit',currentData.get(),serviceData);
