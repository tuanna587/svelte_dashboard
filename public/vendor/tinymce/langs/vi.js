tinymce.addI18n('vi',{
  ...
  "Switch to or from fullscreen mode": "Chuyển sang chế độ toàn màn hình",
  "Open popup menu for split buttons": "Mở menu bật lên cho các nút được chia tách",
  "Focus to element path": "Hướng vào đường dẫn phần tử",
  "Focus to contextual toolbar": "Hướng vào thanh công cụ",
  "Focus to toolbar": "Hướng vào thanh công cụ",
  "Focus to menubar": "Hướng vào thanh menu",
  "Open help dialog": "Mở hộp thoại trợ giúp",
  "Handy Shortcuts": "Phím tắt tiện dụng",
  "Keyboard Navigation": "Điều hướng bàn phím",
  "Version": "Phiên bản",
  "Allow Ads": "Cho phép quảng cáo",
  "Border width": "Độ rộng viền",
  "Border style": "Kiểu bo viền",
  "Restore original size": "Khôi phục ảnh gốc",
  "Insert Keep Format": "Chèn giữ nguyên định dạng"
